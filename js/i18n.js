  ...
  const T = {
    en: {
      ...
      exp: {
        ...
        heroCtaGroupAria: "Secondary actions",
      ...
      contact: {
        ...
        bizNote: "Registered EU business · quotes & invoices in EUR · EU VAT ID DE462790976.",
      },
    ...
    fr: {
      meta: {
        ...
        description:
          "Développeuse mobile senior — Android, Flutter, médias temps réel. Schneider Electric (100+ pays), gouvernement EAU, santé Allemagne. Livraison orientée produit pour le grand public et le service public.",
      },
      ...
      hero: {
        ...
        proof1n: "8+",
        proof1: "ans · responsable mobile senior",
        proof2n: "100+",
        ...
        panelSummary:
          "Livraison production-first et architecture pragmatique — cadrage, implémentation, releases et passation. Collaboration étroite avec produit, design, QA et backend.",
        panelB1: "Livraison de bout en bout — architecture jusqu'au Play Store, App Store et App Gallery",
      ...
      achievements: {
        ...
        a1t: "Schneider Electric · France",
        a1b: "Responsable d'équipe Android sur mySchneider — app B2B mondiale dans 100+ pays, gouvernance Play Store.",
        a2t: "Plateformes mobiles gouvernement EAU",
        a2b: "Responsable technique — Maskan (FTA), Dubai Chambers, Culture & Dubai Police.",
        a3t: "Santé · Allemagne",
      ...
      why: {
        ...
        intro: "Livraison production-first — architecture pragmatique, onboarding rapide et collaboration étroite avec produit, design, QA et backend.",
        ...
        w2b: "Opérationnelle rapidement sur des apps gouvernementales et d'entreprise en jours, pas en mois.",
        w3t: "Livraison production-first",
        w3b: "Publications store, conformité, stabilité et sessions fiables sur réseaux réels.",
        w4t: "Collaboration transverse",
        w4b: "Alignement clair avec produit, design, backend, QA et responsables release.",
      ...
      media: {
        ...
        m1t: "Twilio Video",
        m1d: "Téléconsultations et sessions vidéo live — livraison santé orientée usagers en Allemagne.",
        ...
        m5d: "Alertes backend, dispatch patrouilles et opérations terrain avec exécution fiable en premier et arrière-plan.",
      ...
      expertise: {
        label: "Expertise clé",
        title: "Livraison senior — de l'architecture à la release store",
        intro:
          "Livraison mobile de bout en bout pour produits réglementés et à fort trafic — expérience utilisateur, secteur public, grand public et médias temps réel.",
        ...
        s4t: "Livraison orientée produit",
        s4d: "Collaboration avec produit & design — accessibilité, responsabilité release et décisions production sous pilotage senior",
      ...
      work: {
        ...
        intro: "Missions sélectionnées où architecture, discipline de livraison et publications store comptaient — regroupées par domaine.",
        ...
        g2note: "Responsable technique Android · programmes gouvernementaux (Proxym Middle East)",
      ...
      exp: {
        ...
        present: "Aujourd'hui",
        proxymRole: "Responsable d'équipe Android",
        ...
        wimobiRole: "Responsable technique mobile senior",
        ...
        schneiderSum: 'Responsable Android — <strong>mySchneider</strong> (Schneider Electric, France) : direction équipe Android ; MAP, GitHub/Dependabot, CI/CD Python sur Azure DevOps, publications Play Store — app dans <strong>100+ pays</strong> (mai 2023 – mars 2024).',
        ...
        codecoRole: "Responsable technique & développeuse Flutter",
        codecoTime: "Déc. 2020 — Déc. 2021",
        codecoLoc: "Allemagne",
        codecoSum: "Responsable technique — Gesundheitspersonal ; déploiement Play Store et App Store (déc. 2020 – déc. 2021).",
        ...
        heroCtaGroupAria: "Actions secondaires",
        heroPanelAria: "Livraison mobile en production",
      ...
      contact: {
        ...
        bizNote: "Entreprise UE enregistrée · devis et factures en EUR · TVA intracom. DE462790976.",
      },
    ...
    de: {
      ...
      exp: {
        ...
        heroCtaGroupAria: "Weitere Aktionen",
      ...
      contact: {
        ...
        bizNote: "Registriertes EU-Unternehmen · Angebote & Rechnungen in EUR · USt-IdNr. DE462790976.",
      },
      footer: "© {year} Samira Salah · HB IT Services · Senior Mobile Developer",
    },
  };
