  ...
  const T = {
    en: {
      ...
      achievements: {
        ...
        a1t: "UAE government mobile delivery",
        a1b: "Technical lead on Maskan (FTA), Dubai Chambers, Culture & Police programs.",
        a2t: "Multi-store releases",
        a2b: "Play Store, App Store & Huawei App Gallery in regulated public-sector contexts.",
        a3t: "Real-time voice & video",
        a3b: "Twilio Video, SIP VoIP, live audio, TTS & background media sessions.",
        a4t: "Schneider Electric · France",
        a4b: "Android team lead on mySchneider — global B2B app in 100+ countries.",
        a5t: "8+ years · France, EU & MENA",
        a5b: "Consumer, healthcare, enterprise & public-sector mobile at senior level.",
      },
      why: {
        ...
        w1t: "Architecture without over-engineering",
        w1b: "Modular boundaries, DI and release discipline that scale without slowing teams down.",
        w2t: "Fast onboarding on legacy codebases",
        w2b: "Productive on live government and enterprise apps within days, not months.",
        w3t: "Production-first mindset",
        w3b: "Store releases, compliance, crash budgets and real-network session reliability.",
        w4t: "Strong cross-functional collaboration",
        w4b: "Clear alignment with product, backend, QA and release owners.",
        w5t: "Public sector & high-traffic consumer",
        w5b: "Healthcare, media-scale real-time features and citizen-facing services.",
      },
      media: {
    ...
    fr: {
      ...
      achievements: {
        ...
        a1t: "Delivery mobile gouvernement EAU",
        a1b: "Lead technique sur Maskan (FTA), Dubai Chambers, Culture & Police.",
        a2t: "Releases multi-stores",
        a2b: "Play Store, App Store & Huawei App Gallery en contexte secteur public réglementé.",
        a3t: "Voix & vidéo temps réel",
        a3b: "Twilio Video, VoIP SIP, audio live, TTS & sessions média en arrière-plan.",
        a4t: "Schneider Electric · France",
        a4b: "Lead équipe Android sur mySchneider — app B2B mondiale dans 100+ pays.",
        a5t: "8+ ans · France, UE & MENA",
        a5b: "Grand public, santé, entreprise & secteur public au niveau senior.",
      },
      why: {
        ...
        w1t: "Architecture sans sur-ingénierie",
        w1b: "Modularité, DI et discipline de release qui scale sans ralentir l'équipe.",
        w2t: "Onboarding rapide sur code legacy",
        w2b: "Productive sur apps gouvernementales et enterprise en jours, pas en mois.",
        w3t: "Mindset production d'abord",
        w3b: "Releases stores, conformité, stabilité et sessions fiables sur réseaux réels.",
        w4t: "Collaboration transverse forte",
        w4b: "Alignement clair avec produit, backend, QA et owners release.",
        w5t: "Secteur public & grand public",
        w5b: "Santé, temps réel type média et services citoyens.",
      },
      media: {
    ...
    de: {
      ...
      achievements: {
        ...
        a1t: "Mobile Delivery für VAE-Regierung",
        a1b: "Tech Lead für Maskan (FTA), Dubai Chambers, Culture & Police.",
        a2t: "Multi-Store-Releases",
        a2b: "Play Store, App Store & Huawei App Gallery im regulierten Public Sector.",
        a3t: "Echtzeit-Sprach- & Video-Produkte",
        a3b: "Twilio Video, SIP VoIP, Live-Audio, TTS & Background-Media-Sessions.",
        a4t: "Schneider Electric · Frankreich",
        a4b: "Android Team Lead für mySchneider — globale B2B-App in 100+ Ländern.",
        a5t: "8+ Jahre · Frankreich, EU & MENA",
        a5b: "Consumer, Healthcare, Enterprise & Public Sector auf Senior-Niveau.",
      },
      why: {
        label: "Unterschiede",
        ...
        w1t: "Architektur ohne Over-Engineering",
        w1b: "Modulare Grenzen, DI und Release-Disziplin, die skaliert ohne Teams auszubremsen.",
        ...
        w4t: "Starke cross-funktionale Zusammenarbeit",
        w4b: "Klare Abstimmung mit Produkt, Backend, QA und Release-Ownern.",
        w5t: "Public Sector & High-Traffic Consumer",
        w5b: "Healthcare, Media-nahe Echtzeit-Features und Bürger-Services.",
      },
      media: {
        label: "Media & Streaming",
