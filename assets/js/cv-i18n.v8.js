...
(function () {
  ...
  const T = {
    en: {
      ...
      title: "Senior Freelance Android Developer · Video & public apps",
    ...
    fr: {
      ...
      m1: "8+ ans",
      m1s: "Développement mobile senior",
      m2: "Vidéo & live",
      m2s: "Twilio · WebSocket · FCM",
      m3: "France prouvée",
      m3s: "Schneider · Runnrz · Digitsole",
      ...
      profile: "Profil",
      profileText:
        'Développeuse mobile senior freelance — <strong>8+ ans</strong> de livraison <strong>Android & Flutter</strong> en production (grand public, entreprise, secteur public). Expertise : <strong>architecture mobile</strong>, <strong>temps réel</strong> (Twilio Video, VoIP, WebSocket) et <strong>industrialisation store</strong> (CI/CD → Play Store / App Store). Référence récente : <strong>responsable Android Schneider Electric</strong> (mySchneider, 100+ pays). Contrats & facturation EUR via HB IT Services.',
      offerTitle: "Expertise",
      offer1t: "Architecture & livraison mobile",
      offer1b: "Kotlin · Jetpack Compose · MVVM · Clean Architecture · modularisation à l'échelle",
      ...
      roles: {
        proxym: {
          ...
          desc: "Responsable technique Android sur programmes mobiles gouvernementaux EAU — Maskan (FTA), Dubai Chambers, Dubai Police (Dispatcher, IServe). Architecture modulaire, stratégie GMS/HMS, releases production.",
        },
        wimobi: {
          title: "Responsable technique mobile senior",
          meta: "Jan 2017 — Aujourd'hui · UE · Remote",
          desc: "Responsable technique freelance — cadrage architecture, livraison Android & Flutter et mises en production pour clients UE/MENA (France, Allemagne, Tunisie).",
        },
        schneider: {
          title: "Responsable d'équipe Android",
      ...
      projects: {
        ...
        chambers: {
          ...
          delivered: "Responsable d'équipe ; intégration features ; OCR & extraction OpenAI ; releases Play Store & App Gallery ; migration GMS→HMS.",
        ...
        myschneider: {
          ...
          impact: "App B2B mondiale maintenue en condition de release — rigueur de livraison applicable aux apps grand public à fort trafic.",
        },
        comunik: {
        ...
        gesundheit: {
          ...
          delivered: "Responsable technique Flutter des deux apps ; architecture et fonctionnalités ; soumissions Play Store et App Store de bout en bout.",
        ...
        digitsole: {
          ...
          delivered: "Responsabilité Android sur deux apps compagnons ; SDK Zhor-Tech ZT Core Kit (connexion BLE semelles & flux capteurs) ; migration AWS Amplify ; workflow strings Crowdin ; coaching vocal temps réel.",
