...
(function () {
  ...
  const T = {
    en: {
      ...
      title: "Senior Mobile Developer · Android, Compose & Flutter",
      badgeTitle: "Freelance senior · available",
      badgeBiz: "EUR invoicing",
      m1: "8+ years",
      ...
      summary2: "Led Android delivery for Schneider Electric (100+ countries), UAE government apps in Jetpack Compose (Maskan, Dubai Chambers, Dubai Culture) and regulated healthcare.",
      ...
      offer1b: "Team lead, Jetpack Compose UI, modular architecture, code review and Play Store / App Store release ownership.",
      ...
      roleLabel: "Role",
      impact: "Impact",
      footerL: "EU VAT ID DE462790976 · Quotes & invoices in EUR",
      ...
      roles: {
        proxym: {
          ...
          desc: "Technical lead on UAE government apps (Maskan, Dubai Chambers, Dubai Culture, Dubai Police) — Jetpack Compose UI, architecture, dual-store releases and product/QA alignment for national citizen and field-officer workflows.",
        },
        wimobi: {
      ...
      projects: {
        maskan: {
          ...
          meta: "Technical lead · Jetpack Compose · Play Store",
          role: "Technical lead · Android",
          intro: "Official FTA app — mobile VAT refunds and citizen services for UAE nationals.",
          roleText: "Greenfield Jetpack Compose architecture, refund journeys, OCR capture and Play Store ownership.",
          impact: "National citizen service published on Play Store — proofs submitted from mobile in the field.",
        },
        chambers: {
          sector: "Government · UAE",
          meta: "Team lead · Jetpack Compose · Play Store & App Gallery",
          role: "Android team lead",
          intro: "Official Dubai Chambers app — business services for companies and entrepreneurs in the UAE.",
          roleText: "Team lead on live Jetpack Compose codebase; OCR/OpenAI document extraction; dual-store releases and GMS→HMS migration.",
          impact: "More reliable document processing and predictable release cycles on a production government app.",
        },
        culture: {
          sector: "Government · UAE",
          role: "Android developer",
          intro: "Dubai Culture mobile app — cultural programs, institutions and resident-facing services.",
          roleText: "Jetpack Compose UI delivery and API integrations on a live government codebase.",
          impact: "More cultural services reachable on mobile for Dubai residents and partners.",
        },
        myschneider: {
    ...
    fr: {
      ...
      title: "Développeuse mobile senior · Android, Compose & Flutter",
      badgeTitle: "Freelance senior · disponible",
      badgeBiz: "facturation EUR",
      m1: "8+ ans",
      ...
      summary2: "Direction Android chez Schneider Electric (100+ pays), apps gouvernementales EAU en Jetpack Compose (Maskan, Dubai Chambers, Dubai Culture) et santé réglementée.",
      ...
      offer1t: "Lead & architecture",
      offer1b: "Responsable d'équipe, UI Jetpack Compose, architecture modulaire, revues de code et ownership releases store.",
      ...
      roleLabel: "Rôle",
      impact: "Impact",
      footerL: "TVA intracom. DE462790976 · Devis & factures en EUR",
      ...
      roles: {
        proxym: {
          ...
          desc: "Responsable technique sur apps gouvernementales EAU (Maskan, Dubai Chambers, Dubai Culture, Dubai Police) — UI Jetpack Compose, architecture, releases dual-store et coordination produit/QA pour des workflows citoyens et agents terrain à l'échelle nationale.",
        },
        wimobi: {
      ...
      projects: {
        maskan: {
          ...
          meta: "Responsable technique · Jetpack Compose · Play Store",
          ...
          roleText: "Architecture greenfield Jetpack Compose, parcours remboursement, capture OCR et ownership Play Store.",
        ...
        chambers: {
          ...
          meta: "Responsable d'équipe · Jetpack Compose · Play Store & App Gallery",
          ...
          roleText: "Lead sur codebase Jetpack Compose en production ; OCR/extraction OpenAI ; releases dual-store et migration GMS→HMS.",
        ...
        culture: {
          ...
          intro: "App Dubai Culture — programmes culturels, institutions et services pour résidents et partenaires.",
          roleText: "Livraison UI Jetpack Compose et intégrations API sur codebase gouvernementale en production.",
          impact: "Davantage de services culturels accessibles sur mobile pour les résidents et partenaires de Dubaï.",
        },
        myschneider: {
    ...
    de: {
      ...
      delivered: "Geliefert",
      impact: "Impact",
      footerL: "USt-IdNr. DE462790976 · Angebote & Rechnungen in EUR",
      ...
      roles: {
        proxym: {
          ...
          desc: "Android Technical Lead für Regierungsprogramme VAE — Maskan, Dubai Chambers, Dubai Culture, Dubai Police (Dispatcher, IServe). Jetpack Compose UI, modulare Architektur, GMS/HMS Dual-Store, Production-Releases.",
        },
        wimobi: {
          title: "Senior Mobile Tech Lead",
      ...
      projects: {
        maskan: {
          ...
          meta: "Technical Leader · Jetpack Compose · Play Store",
          intro: "Offizielle FTA-App für VAE-Staatsangehörige — mobile MwSt.-Erstattung, Belegübermittlung und Bürger-Services.",
          roleText: "Greenfield Jetpack Compose-Architektur; Erstattungsflows; OCR-Capture; Google Wallet; Play-Store-Ownership.",
        ...
        chambers: {
          ...
          roleText: "Team Lead auf Live-Jetpack-Compose-Codebase; OCR & OpenAI-Extraktion; Play-Store- & App-Gallery-Releases; GMS→HMS-Migration.",
        ...
        culture: {
          sector: "Behörden · VAE",
          intro: "Mobile Dubai-Culture-App — Kulturprogramme, Institutionen und Services für Bewohner und Partner.",
          roleText: "Jetpack Compose UI und API-Integrationen auf einer Live-Behörden-Codebase.",
          impact: "Mehr Kulturservices mobil erreichbar für Bewohner und Partner in Dubai.",
        },
        myschneider: {
